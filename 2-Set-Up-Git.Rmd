...
Now, we can finally use Git to "clone" a repository found on GitHub to our local machines. To do this, go to the [GitHub repository for this book](https://github.com/dusty-turner/etf-r-git-2020) and click on the green "Code" button. With SSH selected (this should be the default), click the clipboard button to copy the repo URL.

![](img/github_menu.png)

In Git Bash/Terminal, use `cd` to navigate to the folder in which you'd like to create the project folder, then run `git clone` on this URL.
